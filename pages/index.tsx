import { Card, Avatar, Title, Stack, Group, Divider, Text, ActionIcon } from "@mantine/core";
...
const Home: NextPage = () => {
  return (<>
    ...
    <Head>
      <title>luvzee</title>
      <meta name="description" content="alternatív/indie zenész" />
    ...
    <Card radius="md" sx={(theme) => ({ backgroundColor: theme.fn.rgba(theme.colors.dark[7], 1) })} mb="sm" shadow="lg">
      <Group spacing="sm">
        <Avatar imageProps={{ draggable: false }} size={150} src="/img/luvzee-avatar.jpg" alt="luvzee">luzee</Avatar>
        <Stack spacing={4}>
          <Title size={50}>luvzee</Title>
          <Title size={25} order={2} color="dimmed">Alternatív/Indie zenész</Title>
        </Stack>
      </Group>
